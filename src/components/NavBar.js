...
const NavBar = () => {
  ...
  return (
    ...
    justify-between dark:text-light relative z-30 lg:px-16 md:px-12 sm:px-8'
    >

      <button className="flex-col jsutify-center items-center hidden lg:flex" onClick={handleClick}>
        ...
        <nav className='flex items-center justify-center flex-wrap mt-2'>
              ...
              <motion.a href='https://www.linkedin.com/in/kartik-salve1809/' target={'_blank'}
              className='w-6 ml-3 rounded-full sm:mx-1'
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              >
              <LinkedInIcon />
